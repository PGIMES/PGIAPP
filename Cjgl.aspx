<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cjgl.aspx.cs" Inherits="Cjgl" %>
        ...
        <div id="allContainer" class="menus-normal">
            <dl class="menus-module" style=""> 
                ...
                <dt class="menus-title" style="background-color:#008083;height:35px">
                    <div  style="float:left;width:49%;border:0px solid #F00;">业务系统</div> 
                ...
                <dd id="btn1" class="menus-item"  > 
                    <a href="Cjgl1.aspx"> <span class="mi-info logo"></span> <span class="mi-info txt">MES</span> <span class="mi-info check txt">进入</span> </a> 
                </dd> 
                <dd id="btn2" class="menus-item"  > 
                    <a href="javascript:void(0);"> <span class="mi-info logo"></span> <span class="mi-info txt">OA</span> <span class="mi-info check txt">进入</span> </a> 
                </dd> 
                <dd id="btn3" class="menus-item"  > 
                    <a href="javascript:void(0);"> <span class="mi-info logo"></span> <span class="mi-info txt">API</span> <span class="mi-info check txt">进入</span> </a> 
                </dd> 
