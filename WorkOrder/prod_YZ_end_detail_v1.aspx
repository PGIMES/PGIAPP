<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prod_YZ_end_detail_v1.aspx.cs" Inherits="prod_YZ_end_detail_v1" %>
        ...
        <div class="page">
            <div class="page__bd" id="t2" style="height: 100%;">
                ...
                <% 
                    ...
                    System.Data.DataTable dt_m = ds.Tables[1];
                    System.Data.DataTable dt_d = ds.Tables[2];
                            ...
                            <div class="weui-cells page-category-content">
                                ...
                                <div class="weui-cell__bd" style="padding-left:15px;margin-bottom:5px;"> 
                                    <span class="weui-form-preview__value" style="color:#999999;font-size: smaller;line-height:2">
                                       <%= dr_["pgino"] + "," + dr_["pn"] %> <%=    "下料数:" +dr_["off_qty"]  %>
                                    </span> 
                                    <span class="weui-form-preview__value" style="color:#999999;font-size: smaller;line-height:2">
