<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bhgp_Apply_yz.aspx.cs" Inherits="bhgp_Apply_yz" %>
    ...
    <script>
        ...
        $(function () {
                ...
                if ($("#op").val() != "") {
                    ...
                    if (parseInt(_op) > 900) {
                        $.ajax({
                            ...
                            data: "{'domain': '" + $("#domain").val() + "','ref_order':'" + $("#ref_order").val() + "','pgino':'" + $('#pgino').val() + "','op':'" + _op + "'}",
            ...
            $("#rscode").change(function () {
                $.ajax({
                    type: "post",
                    url: "bhgp_Apply_yz.aspx/rs_data",
        ...
        function pgino_change(pgino) {
            $.ajax({
                type: "post",
                url: "bhgp_Apply_yz.aspx/pgino_change",
                data: "{'pgino':'" + pgino + "','domain':'" + $("#domain").val() + "','workshop':'" + "<%= _workshop %>" + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,//默认是true，异步；false为同步，此方法执行完在执行下面代码
                success: function (data) {
...
<body>    
    ...
    <script>
        ...
        if ("<%= _ismodify %>"=="Y") {
            ...
            $.ajax({
                type: "post",
                url: "bhgp_Apply_yz.aspx/init_pgino",
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type: "post",
            url: "bhgp_Apply_yz.aspx/init_rs",
