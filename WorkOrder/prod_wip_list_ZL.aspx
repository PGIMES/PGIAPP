<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prod_wip_list_ZL.aspx.cs" Inherits="prod_wip_list_v4" %>
                        ...
                        <div id="tab1" class="weui-tab__content">
                            <%----生产中-----%>
                             <div class="weui-form-preview">                                 
                                <%
                                    System.Data.DataTable dt_line = null;// ViewState["dt_data_1"] as System.Data.DataTable;
                                    int rowscount = 0; //dt_line.Select("ispartof<>'部分' and line<>'组装件'").Count();
                                    int partcount = 0;// dt_line.Select("ispartof='部分' and line<>'组装件'").Count();
                                    int backcount = 0;// dt_line.Select(" isnull(workorder_wip,'') <>'' ").Count();//and line<>'组装件'

                                    System.Data.DataView dataView = null;//dt_line.DefaultView;
                                    System.Data.DataTable dtLineDistinct = null;//dataView.ToTable(true, "line");
                                    System.Data.DataTable dtispartof= null;//dataView.ToTable(false, "line", "ispartof");
                            ...
                            <div class="weui-form-preview">
                                <%
                                    dt_line = ViewState["dt_data_qc2"] as System.Data.DataTable;
                                    ...
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <div class="weui-cells__title weui-flex__item">
                                                <i class="icon nav-icon icon-49"></i> 二车间 待终检
                                            ...
                                            <div class="weui-cells">
                                                <%dataView = dt_line.DefaultView;
                                                    ...
                                                    foreach (System.Data.DataRow drLine in dtLineDistinct.Rows)
                                                    {
                                                        ...
                                                        dtrowswip= dt_line.Select("line='"+line+"' and ispartof<>'部分' and loading_type<>'99' ");
                                                        dtrowspart = dt_line.Select("line='"+line+"' and ispartof='部分' ");
                                                        dtrowsback= dt_line.Select("line='"+line+"' and isnull(workorder_wip,'') <>'' ");
                                                %>
                                                <ul class="collapse2 ">
                                                    <li class="js-show LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        ...
                                                        <div class="page-category js-categoryInner a_body" style="display:none ">
                                                            <div>
                                                                <%                                                  
                                                                    System.Data.DataTable dt = ViewState["dt_data_qc2"] as System.Data.DataTable;
                                                                ...
                                                                <a class="weui-cell  weui-cell_access " style="color: black" href="prod_qcc_part_detail.aspx?dh=<%=dr["qc_dh"] %>&type=0">
                                                                    ...
                                                                    <div class="weui-cell__bd " style="font-size: smaller">
                                                                        ...
                                                                        <span class="weui-badge  weui-badge-tr margin20-l" style="font-size: x-small;"><%=dr["ispartof"] %></span>
                                                                        <br />
                            ...
                            <div class="weui-form-preview">
                                <%
                                    dt_line = ViewState["dt_data_gp2"] as System.Data.DataTable;
                                ...
                                <ul class="collapse">
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <div class="weui-cells__title weui-flex__item">
                                                <i class="icon nav-icon icon-49"></i> 二车间 待GP12                                                
                                                <span class="weui-badge  bg-<% =(rowscount==0?"gray":"blue") %> margin20-l"><% =rowscount %></span>
                                                <span class="weui-badge  bg-<% =(partcount==0?"gray":"orange") %> ">部<% =partcount %></span>
                                                <span class="weui-badge  bg-<% =(backcount==0?"gray":"red") %> "  >返<% =backcount %></span> 
                                            </div>
                                            ...
                                            <div class="weui-cells">
                                                ...
                                                <ul class="collapse2 ">
                                                    <li class=" LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        ...
                                                        <div class="page-category js-categoryInner a_body" style="display:none ">
                                                            <%                                                  
                                                                System.Data.DataTable dt = ViewState["dt_data_gp2"] as System.Data.DataTable;
                                                                foreach (System.Data.DataRow dr in dt.Select("line='" + line + "'"))
                                                                {
                                                                    if (dr["ispartof"].ToString() == "部分"||dr["ispartof"].ToString() == "零箱返线")
                                                                    { %>
                                                            ...
                                                            <a class="weui-cell  weui-cell_access " style="color: black" href="prod_qcc_part_detail.aspx?dh=<%=dr["workorder"] %>&type=9&laiyuan=<%=dr["laiyuan"].ToString()=="终检完待GP12"?"终检单号":"完工单号" %>">
                                                                <div class="weui-mark-vip"><span class="weui-mark-lt bg-warning"></span></div>
                                                                <div class="weui-cell__hd">
                                                                    <i class="fa fa-thermometer-full" aria-hidden="true"></i>
                                                                </div>
                            ...
                            <div class="weui-form-preview">
                                <%
                                    dt_line = ViewState["dt_data_qc3"] as System.Data.DataTable;
                                    rowscount = dt_line.Select("ispartof<>'部分' and loading_type<>'99'").Count();
                                    partcount = dt_line.Select("ispartof='部分'").Count();
                                    backcount = dt_line.Select(" isnull(workorder_wip,'') <>'' ").Count();
                                %>
                                <ul class="collapse">
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <div class="weui-cells__title weui-flex__item">
                                                <i class="icon nav-icon icon-49"></i> 三车间 待终检
                                                <span class="weui-badge  bg-<% =(rowscount==0?"gray":"blue") %>  margin20-l" ><% =rowscount %></span>
                                                <span class="weui-badge  bg-<% =(partcount==0?"gray":"orange") %>" >部<% =partcount %></span>  
                                                <span class="weui-badge  bg-<% =(backcount==0?"gray":"red") %> "  >返<% =backcount %></span>                                              
                                            </div>
                                                ...
                                                <ul class="collapse2 ">
                                                    <li class="js-show LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        ...
                                                        <div class="page-category js-categoryInner a_body" style="display:none ">
                                                            <div>
                                                                <%                                                  
                                                                    System.Data.DataTable dt = ViewState["dt_data_qc3"] as System.Data.DataTable;
                                                                    foreach (System.Data.DataRow dr in dt.Select("line='" + line + "'"))
                                                                    {
                                                                        if (dr["ispartof"].ToString() == "部分"||dr["ispartof"].ToString() == "零箱返线")
                                                                        { %>
                            ...
                            <div class="weui-form-preview">
                                <%
                                    dt_line = ViewState["dt_data_gp3"] as System.Data.DataTable;
                                ...
                                <ul class="collapse">
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <div class="weui-cells__title weui-flex__item">
                                                <i class="icon nav-icon icon-49"></i> 三车间 待GP12                                                
                                                <span class="weui-badge  bg-<% =(rowscount==0?"gray":"blue") %> margin20-l"><% =rowscount %></span>
                                                <span class="weui-badge  bg-<% =(partcount==0?"gray":"orange") %> ">部<% =partcount %></span>
                                                <span class="weui-badge  bg-<% =(backcount==0?"gray":"red") %> "  >返<% =backcount %></span> 
                                            </div>
                                            ...
                                            <div class="weui-cells">
                                                ...
                                                <ul class="collapse2 ">
                                                    <li class=" LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        ...
                                                        <div class="page-category js-categoryInner a_body" style="display:none ">
                                                            <%                                                  
                                                                System.Data.DataTable dt = ViewState["dt_data_gp3"] as System.Data.DataTable;
                                                                foreach (System.Data.DataRow dr in dt.Select("line='" + line + "'"))
                                                                {
                                                                    if (dr["ispartof"].ToString() == "部分"||dr["ispartof"].ToString() == "零箱返线")
                                                                    { %>
                            ...
                            <div class="weui-form-preview">
                                <%
                                    dt_line = ViewState["dt_data_qc4"] as System.Data.DataTable;
                                    rowscount = dt_line.Select("ispartof<>'部分' and loading_type<>'99'").Count();
                                    partcount = dt_line.Select("ispartof='部分'").Count();
                                    backcount = dt_line.Select(" isnull(workorder_wip,'') <>'' ").Count();
                                %>
                                <ul class="collapse">
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <div class="weui-cells__title weui-flex__item">
                                                <i class="icon nav-icon icon-49"></i> 四车间 待终检
                                                <span class="weui-badge  bg-<% =(rowscount==0?"gray":"blue") %>  margin20-l" ><% =rowscount %></span>
                                                <span class="weui-badge  bg-<% =(partcount==0?"gray":"orange") %>" >部<% =partcount %></span>  
                                                <span class="weui-badge  bg-<% =(backcount==0?"gray":"red") %> "  >返<% =backcount %></span>                                              
                                            </div>
                                                ...
                                                <ul class="collapse2 ">
                                                    <li class="js-show LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        ...
                                                        <div class="page-category js-categoryInner a_body" style="display:none ">
                                                            <div>
                                                                <%                                                  
                                                                    System.Data.DataTable dt = ViewState["dt_data_qc4"] as System.Data.DataTable;
                                                                    foreach (System.Data.DataRow dr in dt.Select("line='" + line + "'"))
                                                                    {
                                                                        if (dr["ispartof"].ToString() == "部分"||dr["ispartof"].ToString() == "零箱返线")
                                                                        { %>
                            ...
                            <div class="weui-form-preview">
                                <%
                                    dt_line = ViewState["dt_data_gp4"] as System.Data.DataTable;
                                    rowscount = dt_line.Select("ispartof<>'部分'").Count();
                                    partcount = dt_line.Select("ispartof='部分'").Count();
                                    backcount = dt_line.Select(" isnull(workorder_wip,'') <>'' ").Count();
                                %>
                                <ul class="collapse">
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <div class="weui-cells__title weui-flex__item">
                                                <i class="icon nav-icon icon-49"></i> 四车间 待GP12                                                
                                                <span class="weui-badge  bg-<% =(rowscount==0?"gray":"blue") %> margin20-l"><% =rowscount %></span>
                                                <span class="weui-badge  bg-<% =(partcount==0?"gray":"orange") %> ">部<% =partcount %></span>
                                                <span class="weui-badge  bg-<% =(backcount==0?"gray":"red") %> "  >返<% =backcount %></span> 
                                            </div>
                                            ...
                                            <div class="weui-cells">
                                                ...
                                                <ul class="collapse2 ">
                                                    <li class=" LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        ...
                                                        <div class="page-category js-categoryInner a_body" style="display:none ">
                                                            <%                                                  
                                                                System.Data.DataTable dt = ViewState["dt_data_gp4"] as System.Data.DataTable;
                                                                foreach (System.Data.DataRow dr in dt.Select("line='" + line + "'"))
                                                                {
                                                                    if (dr["ispartof"].ToString() == "部分"||dr["ispartof"].ToString() == "零箱返线")
                                                                    { %>
                            ...
                            <div class="weui-form-preview">
                                <ul class="collapse">
                                    <li class="js-show">
                                        <div class="weui-flex js-category">
                                            <%
                                                dt_line = ViewState["dt_data_drk"] as System.Data.DataTable;
                                                rowscount = dt_line.Rows.Count;                                                 
                                            %>
                                            <div class="weui-cells__title  weui-flex__item"><i class="icon nav-icon icon-49"></i> 终检、GP12完成(24小时)                                                 
                                        ...
                                        <div class="page-category js-categoryInner">
                                            <div class="weui-cells">
                                                <%                                          
                                                    dataView = dt_line.DefaultView;
                                                    dataView.Sort = "scx_workshop,line";
                                                    dtLineDistinct = dataView.ToTable(true, "scx_workshop","line");
                                                ...
                                                <ul class="collapse2 ">
                                                    <li class=" LH " style="margin-top: 0px; margin-bottom: 0px">
                                                        <div class="weui-flex js-category2 " onclick="showorhide(this);">
                                                            <div class="weui-cells__title  weui-flex__item LH"  ><i class="icon nav-icon icon-22 color-success "></i><%=drLine["scx_workshop"]+" "+line %><span class="weui-badge bg-blue margin20-l " style="margin-right: 15px;"><% =(ViewState["dt_data_drk"] as System.Data.DataTable).Select("line='" + line + "'").Count() %></span></div>
                                                            <i class="icon icon-74 right"></i>
                                                        </div>
                                                        <div class="page-category js-categoryInner a_body" style="display: none">
                                                            <%                                                  
                                                                System.Data.DataTable dt = ViewState["dt_data_drk"] as System.Data.DataTable;                                                               
                                                                 
                                                                foreach (System.Data.DataRow dr in dt.Select("line='" + line + "'"))
                                                                {%>
                                                            <a class="weui-cell  weui-cell_access " style="color: black" href="/workorder/prod_qcc_part_detail.aspx?dh=<%=dr["workorder"] %>">
