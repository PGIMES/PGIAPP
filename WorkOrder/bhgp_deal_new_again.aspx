<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bhgp_deal_new_again.aspx.cs" Inherits="WorkOrder_bhgp_deal_new_again" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="weui-cells weui-cells_form">
            ...
            <div class="weui-form-preview">
                ...
                <asp:TextBox ID="cz_sum_qty" class="weui-input" ReadOnly="true" placeholder="" style="color:gray;display:none;" runat="server"></asp:TextBox>
            ...
            <div class="weui-form-preview__bd">
                ...
                <asp:Repeater runat="server" ID="Repeater1_a">
                    <ItemTemplate>
                        <div class="weui-form-preview__item" style="border-top:1px solid #e5e5e5">
