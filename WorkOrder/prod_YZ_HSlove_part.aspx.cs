...
public partial class prod_YZ_HSlove_part : System.Web.UI.Page
{
    public string _workshop = "";
    public string _dh = "";//仓库接收 扫码进来
    public string _ck = "";//仓库接收 扫码进来  上级菜单是 仓库

    public DataTable dtHCL;
    public DataTable dtHCL_m;
    public DataTable dtHCL_dtl;
    ...
    private void GetData()
    {
        ...
        string sql = string.Format("[usp_app_YZ_Hsolve_part] '{0}'", _dh);
