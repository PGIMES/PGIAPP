...
public partial class WorkOrder_bhgp_Apply_list_V1 : System.Web.UI.Page
{
    ...
    private void GetData(string emp)
    {
        ...
        list_98.DataSource = dt_98; list_98.DataBind(); Label_98.Text = "(" + dt_98.Rows.Count + ")";
        ...
        list_98_my.DataSource = dt_98_my; list_98_my.DataBind(); Label_98_my.Text = "(" + dt_98_my.Rows.Count + ")";
